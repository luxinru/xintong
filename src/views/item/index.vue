<template>
    <div class="item-container">
        <div class="item-header">
            <div class="tree-notice-box">
                <div class="tree-notice">
                    <van-notice-bar background="#ffffff" color="#1B0A1C" :text="horn_msg">
                        <template #left-icon>
                            <img src="./../../assets/images/shufeng/index/index-6.png" alt=""/>
                        </template>
                    </van-notice-bar>
                </div>
            </div>
			...
			<div style="margin-top:-100px;" @click="handleTreeListItemClick(11)">
			<img style="width: 100%;" src="../../stutia/touzi_beijingbt.png"/>
			</div>
