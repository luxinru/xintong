    ...
    <div class="my-index-container">
        ...
        <div class="my-assets-content">
            ...
            <div class="my-user-info-bottom">
				...
				<div class="my-user-info-bottom-btn two-btn" style="margin-left:90px;">
		...
		data() {
			return {
                ...
                infoListOne: [                    
                    ...
                    {key: 'notice2', name: '站内信', subTitle: '',  style: {width: '39px', height: '39px'}},   
                ],
                infoListTwo: [
