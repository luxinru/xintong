<template>
    ...
    <!--            </label>-->
    <!--            &lt;!&ndash;                <div class="forget_box">&ndash;&gt;-->
    <!--            &lt;!&ndash;                    <router-link to="/forgetpwd" class="forget"><span class="icon">&nbsp;?</span><span class="info">忘记密码</span></router-link>&ndash;&gt;-->
    <!--            &lt;!&ndash;                </div>&ndash;&gt;-->
    ...
    <div class="retrieve-password-container">
        <div class="retrieve-password-form">
            <div class="item">
                ...
                <input v-model="passwd" type="password" placeholder="请输入您的登录密码">
            </div>
            <div class="item">
                <div class="left">
                    <!-- <img src="./images/login-icon.png" alt=""> -->
            ...
            <div class="item">
                ...
                <input v-model="snpasswd" type="password" placeholder="请再次输入密码">
            </div>
            <!-- <van-field v-model="passwd" label-width="1.7rem" type="password" label="登录密码" placeholder="请输入您的登陆密码" />
            <van-field v-model="npasswd" label-width="1.7rem" type="password" label="新的密码" placeholder="请输入新的密码"/>
            <van-field v-model="snpasswd" label-width="1.7rem" type="password" label="确认密码" placeholder="请再次输入密码"/> -->
        </div>
        <!-- <div class="retrieve-password-form-footer">
            <div class="form-btn" @click="handleSubmit">确认修改</div>
        </div> -->
        <div class="form-btn" @click="handleSubmit">确认修改</div>
    </div>
</template>
