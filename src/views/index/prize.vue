...
export default {
  ...
  created() {
    this.$parent.footer(false) //底部导航栏
  },
  mounted() {
...
.container {
  ...
  .wheel-bg {
    width: 305px;
    height: 305px;
    background: url('~@/assets/0226/转盘 拷贝.png') no-repeat center top;
    background-size: 100%;
    color: #fff;
    font-weight: 500;
    display: flex;
