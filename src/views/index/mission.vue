			...
			<div class="task-list-box">
				...
				<div class="task-list-item">
					<div class="task-list-item-left">
						...
						<div class="item-title-box">
                            ...
                            <div class="item-sub-title">共享现金红包</div>
                        </div>
				...
				<div class="task-list-item">
					<div class="task-list-item-left">
                        ...
                        <div class="item-title-box">
                            ...
                            <div class="item-sub-title">健康生活积分奖励</div>
                        </div>
						<!-- <div class="item-icon icon-1"></div> -->
						<div class="item-title-right">
							<div class="item-icon icon-1"></div>
					...
					<div class="task-list-item-right" :class="{'active-btn': mission.answer_status}" @click="handleTaskListItem(7)">{{mission.answer_status ? '已完成' : '去完成'}}</div>
				</div>
				...
				<div class="task-list-item">
					<div class="task-list-item-left">
				        ...
				        <div class="item-title-box">
				            <div class="item-title">抽奖</div>
				            <div class="item-sub-title">参加抽奖活动</div>
				        </div>
						<!-- <div class="item-icon icon-1"></div> -->
						<div class="item-title-right">
							<div class="item-icon icon-1"></div>
					...
					<div class="task-list-item-right" :class="{'active-btn': mission.yue_bao_status == true}" @click="handleTaskListItem(8)">{{mission.yue_bao_status == true ? '已完成' : '去完成'}}</div>
				</div>
